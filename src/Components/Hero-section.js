...
const [slidNextBtn, setSlidNextBtn] = React.useState(true);
  ...
  return (
    <>
     <div className="relative pl-7 pr-[100px] mt-5 mb-2 z-[999999999999999999999999] py-5 gap-[170px] mx-auto max-w-[1600px] flex items-center justify-between text-white">
         <div>
        ...
        <div className="flex gap-[100px] mt-16">
         ...
         <div className='relative z-[99999999999] w-full min-w-[440px] max-w-[440px] top-silder'>
         <Swiper 
         slidesPerView={1}
         onSwiper={(swiper) => {
            setTimeout(() => {
          ...
          }} modules={[Navigation]} className="mySwiper min-h-[580px] w-full h-full">
       
        <SwiperSlide className="relative px-10 mx-0 my-0 pt-[40px]  min-w-[440px] max-w-[440px] min-h-[300px]">
            ...
            <div className="flex justify-between items-center mt-2">
                <div className="text-[#FFE302] text-[21px] font-[500]">0.10 ETH</div>
        ...
        <SwiperSlide className="relative px-10 mx-0 my-0 pt-[40px]  min-w-[440px] max-w-[440px] min-h-[300px]">
            ...
            <div className="flex justify-between items-center mt-2">
                <div className="text-[#FFE302] text-[21px] font-[500]">0.06 ETH</div>
                <div className="opacity-50 text-sm">Created 22/01/2022</div>
            </div>
      ...
      <div className="w-full z-[999999999999] absolute top-[45%] left-0 flex items-center justify-between gap-6 mt-10">
                <button
